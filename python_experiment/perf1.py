...
def calculate_latency(appName="ETLTopologySYS"):
    ...
    try:
        ...
        if throughput > 0:
            successRate = sum(latency_bucket)*1.0/throughput
        ...
        print(e)
    return tail_latency, throughput, successRate 


url = "http://129.114.25.146:8080/topology.html?id=ETLTopologyTAXI-23-1687510971"
