...
${home_path}storm/bin/storm kill ETL_SQL_Topology_sys
...
${home_path}storm/bin/storm jar ${home_path}storm/riot-bench/modules/storm/target/iot-bm-storm-0.1-jar-with-dependencies.jar in.dream_lab.bm.stream_iot.storm.topo.apps.ETL_SQL_Topology C ETL_SQL_Topology_sys ${home_source}SYS_sample_data_senml.csv SYS-10  100.0   ${home_path}storm/riot-bench/output/    ${home_source}tasks.properties  test
