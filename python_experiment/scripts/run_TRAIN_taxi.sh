...
${home_path}storm/bin/storm jar $app_path in.dream_lab.bm.stream_iot.storm.topo.apps.${app_name} C ${app_name} $input_name PLUG-210 $scale $output_path ${home_source}tasks_TAXI.properties test
