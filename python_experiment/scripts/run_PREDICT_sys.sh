...
case "$option" in
   ...
   "default") echo "using default scheduler"
	topologyMap='{"spout1":"core1","SenMLParseBoltPRED":"edge3","DecisionTreeClassifyBolt":"edge3","LinearRegressionPredictorBolt":"edge3","BlockWindowAverageBolt":"edge1","ErrorEstimationBolt":"edge1","MQTTPublishBolt":"edge1","sink":"edge3"}'
   ;;
   "resource") echo "using resource aware scheduler"
	# Resource aware 
        topologyMap="spout1:core1,SenMLParseBoltPRED:edge1,DecisionTreeClassifyBolt:edge1,LinearRegressionPredictorBolt:edge1,BlockWindowAverageBolt:edge1,MQTTPublishBolt:edge1,ErrorEstimationBolt:edge1,sink:edge3"
   ;;
   "amnis") echo "using amnis scheduler"
 	# Amnis methods
	topologyMap='{"spout1":"core1","SenMLParseBoltPRED":"edge1","DecisionTreeClassifyBolt":"edge1","LinearRegressionPredictorBolt":"edge1","BlockWindowAverageBolt":"edge1","ErrorEstimationBolt":"edge3","MQTTPublishBolt":"edge1","sink":"edge3"}'
   ;;
   "coda") echo "using  coda scheduler"
 	# method coda
	topologyMap='{"spout1":"core1","SenMLParseBoltPRED":"worker1","DecisionTreeClassifyBolt":"worker1","LinearRegressionPredictorBolt":"worker1","BlockWindowAverageBolt":"worker1","ErrorEstimationBolt":"worker1","MQTTPublishBolt":"worker1","sink":"edge3"}'
   ;;
