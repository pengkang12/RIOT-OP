...
${home_path}storm/bin/storm jar $app_path in.dream_lab.bm.stream_iot.storm.topo.apps.${app_name} C ${app_name}_$data_type $input_name SENML-2100  0.1 $output_path ${home_source}tasks.properties test
